# CARLA_535_Project
This repository is the host of a project utilizing CARLA and our TOKEN setup.  
By: Thomas and Yussef
...
Proceed to verify the installation by running:  
`pip list` and cross reference the requirements.txt file.

## 4. Add the CARLA install folder to Python environment variables
Add the `carla` and `carla/agents` directories as part of a new user variable (absolute path to these directories).  
You can name it `PYTHONPATH`.
